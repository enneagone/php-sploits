...
<body>
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
        <div class="container"><a class="navbar-brand" href="/">Cyber-Security</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <form method="POST" action="/logout.php">
                    <button class="btn btn-light action-button" role="button" action="/logout.php">Logout</button>
                </form>
            </div>
        </div>
    </nav>
